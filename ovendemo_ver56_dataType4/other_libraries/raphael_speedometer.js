Raphael.fn.speedometer = function(id,width,height){    
    ...
    var o = {
    	...
    	lightAngle:0, lightDistance:0.5,
	...
	*/
	function getAngle(position){ 
  	...
  	function init(weight){
		...
		plateShade = "#000000";"#"+((parseInt("0x"+o.plateColor.substr(1,6)) & 0xfefefe) >> 1).toString(16);
		console.log("plateShade:"+plateShade);
		plate.attr("fill", "r("+fillX+","+fillY+")" + o.plateColor);
    ...
    return{ 
    	...
    	position:function(position){
    		var angle = position; 
    		needleGroup.rotate(position,h,k);   
    	},
